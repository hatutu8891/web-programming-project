...
public class ReviewDao {
    ...
    private static final String INSERT_REVIEW_SQL = "INSERT INTO reviews (uID, pID, rating, comment, rDate) VALUES (?, ?, ?, ?, ?)";
    ...
    public void addReview(Review review) {
        JDBIConnect.get().useHandle(handle ->
                handle.createUpdate(INSERT_REVIEW_SQL)
                        ...
                        .bind(1, review.getProductId())
                        .bind(2, review.getRating())
                        .bind(3, review.getComment())
                        .bind(4, review.getReviewDate())
                        .execute()
        );
    }
