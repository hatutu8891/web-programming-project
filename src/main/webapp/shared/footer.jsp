                ...
                <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary border-inner p-4">
                    <a href="<c:url value='/index.jsp'/>" class="navbar-brand">
                        ...
                        <h1 class="m-0 text-uppercase text-white"><i
                                class="fa fa-birthday-cake fs-1 text-dark me-3"></i>SlowlyCake</h1>
                    </a>
                    <p class="mt-3">Chào mừng đến với SlowlyCake! <br></br>
                        Với tôn chỉ "Chậm mà chắc", chúng tôi hứa hẹn sẽ tạo ra những chiếc bánh kem ngon và đẹp mắt cho
                        mọi dịp lễ.
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mt-4">
                            <a class="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 me-2"
                               href="https://facebook.com"><i class="fab fa-facebook-f fw-normal"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 me-2"
                               href="https://instagram.com"><i class="fab fa-instagram fw-normal"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 me-2"
                               href="https://x.com"><i class="fab fa-x-twitter fw-normal"></i></a>
                            <a class="btn btn-lg btn-primary btn-lg-square border-inner rounded-0 me-2"
                               href="https://github.com/hatutu8891/web-programming-project"><i
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-secondary mb-2" href="<c:url value='/index.jsp'/>"><i
                                    class="bi bi-arrow-right text-primary me-2"></i>Trang chủ</a>
                            <a class="text-secondary mb-2" href="#"><i class="bi bi-arrow-right text-primary me-2"></i>Về
                                Chúng tôi</a>
                            <a class="text-secondary mb-2" href="<c:url value='/service.jsp'/>"><i
                                    class="bi bi-arrow-right text-primary me-2"></i>Dịch vụ</a>
                            <a class="text-secondary" href="<c:url value='/contact.jsp'/>"><i
